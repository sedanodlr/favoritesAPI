...
// @LINE:8
private[this] lazy val controllers_UserController_createUser1_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("user"))))
private[this] lazy val controllers_UserController_createUser1_invoker = createInvoker(
controllers.UserController.createUser(),
HandlerDef(this.getClass.getClassLoader, "", "controllers.UserController", "createUser", Nil,"POST", """ Create User""", Routes.prefix + """user"""))
...
// @LINE:8
case controllers_UserController_createUser1_route(params) => {
   call { 
        controllers_UserController_createUser1_invoker.call(controllers.UserController.createUser())
   }
}
